...
local ItemPool = {
    -- 1st floor (base)
    {
        ...
        { class = 'item_hlvr_clip_shotgun_single', weight = 0.7, max = 8 },
    ...
    -- 2nd floor (damaged)
    {
        ...
        { class = 'item_hlvr_clip_shotgun_pair', weight = 0.4, max = 3 },
        { class = 'item_hlvr_clip_rapidfire', weight = 0.65, max = 4 },
